...
const ApplyJob = require("../Model/ApplyJob.js").ApplyJob;
...
async function sendEmail(user) {
    ...
    mail(user, "MinhNhat - Cấp mã xác nhận", code);
    return code;
}
...
module.exports = { insertUser, updateUser, forgotPassword, loginUser, applyJob, updatePasswordByUsername, followPost, unfollowPost, followCompany, unfollowCompany, getAllPostFollowed, getAllCompanyFollowed }