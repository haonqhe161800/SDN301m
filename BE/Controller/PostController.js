const searchByKeyword = require("../DAO/Search.js").searchByKeyword;
...
module.exports = { getPostsByCompanyId, getAllPosts, getPostById, insertPost, updatePost, getPostsByTitle, searchPostsByKeyword, changePostStatus, deletePostById }