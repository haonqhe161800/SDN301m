                ...
                <div className='flex justify-center gap-5 items-center'>
                    <div className='shadow-lg rounded p-4 md:w-[58%] relative'>
                        ...
                        <div className='btn-create text-white absolute right-6 top-6'>
                            <button onClick={ () => { nav("/tao-cv")}} className='bg-[#1b224e] rounded-lg py-3 px-4'><span className='text-[0.9em]'>Tạo hồ sơ mới </span><TiPlusOutline size={18} className='inline-block' /></button>
                        </div>
