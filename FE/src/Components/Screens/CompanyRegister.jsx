        ...
        <div className="d-flex flex-shrink">
            <div className="mx-5 w-50">
                <div className="mt-20">
                    ...
                    <p className="text-sm my-4">Bạn đang đăng ký tài khoản doanh nghiệp tại MinhNhat. Nền tảng trực tuyến số kết nối ứng viên và doanh nghiệp, giải pháp công nghệ số.</p>
                    <Form >
