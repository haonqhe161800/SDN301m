                ...
                <ul className='px-4'>
                    {
                        type === 2 ?
                            ...
                            <>
                                ...
                                <li className='p-4  border-b cursor-pointer hover:bg-orange-600 ease-linear duration-200'><NavLink to={'/cac-cong-ty-con'} className={({ isActive }) => (isActive ? "border-b-4 border-orange-500" : "")}>Các công ty </NavLink></li>
